...
//多条统计 根据api统计 和 (根据本机IP + api 统计)
func ApiCountAndByIP(apiName string) {
	var buffer bytes.Buffer
	buffer.WriteString(statusUdpStruct.BufferStringJoin(".error.", statusUdpStruct.LocalIpAndPort, ".", apiName, ":1|c"))
