...
func Test_StatLogInit(t *testing.T){
	err := StatLogInit("statLogPath", "statLogName", "prd.palmgroup.access", "172.17.40.21:8125")
	if err!=nil {
...
func Test_Stat(t *testing.T){
	StatLogInit("statLogPath", "statLogName", "prd.palmgroup.access", "172.17.40.21:8125")
